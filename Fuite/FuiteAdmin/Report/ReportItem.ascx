...
<div class="report-item round" >
    <a runat="server" id="link" href="../Details.aspx">
        <span class="id">#<%= this.Report.Id %> Nb:<%= this.Report.Quantity %></span><span class="date">Le <%= this.Report.Date.ToString("dd/MM/yy hh:mm") %></span><span class="ip">Par <%= this.Report.Ip %></span>
    </a>
